...
func _ready() -> void:
  ...
  var string_name_var = &"StringName var"
  var nil_var = null
  ...
  var vector2i_array: Array[Vector2i] = [Vector2i(11,12), Vector2i(21,22)]
  var nested_dict = {
  ...
  var typed_dict: Dictionary[Vector2i, Array] = {
    Vector2i(11,12): [Vector3i(11,12,13), Vector3i(21,22,23)]
  }
  var stringname_key_dict: Dictionary[StringName, StringName] = {
      &"stringname_key": &"stringname value",
  }
  ...
  member_signal.connect(signal_connected_func)
